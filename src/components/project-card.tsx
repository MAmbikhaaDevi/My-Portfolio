...
export function ProjectCard({ title, emoji, githubUrl, liveUrl }: ProjectCardProps) {
  return (
    <Card className="flex flex-col bg-background/50 backdrop-blur-sm overflow-hidden transform transition-all duration-300 hover:-translate-y-2 glow-on-hover">
      <CardHeader>
